...
public class IolistController {
	...
	public String list(Model model) {
		/*
		 * 새로 입력을 수행할때 Default값을 만들어서 form에 세팅하기
		 */
		// 서버의 현재날짜를 문자열로 생성
		Date date = new Date();
	 ...
	 * 입력폼에서 해당값을 입력하지않고 전송을 하면 
	 * 
	 * 400 오류가 발생 한다.
	 * Type.valueof() method에서 exception이 발생하기 떄문이다.
	 * 
